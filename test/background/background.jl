...
@testset "background/Background: sigma clipping" begin
    x = [1, 2, 3]
...
@testset "background/Background: estimate_background interface" begin
    data = ones(100, 100)
...
@testset "background/Background: flat background" begin
...
@testset "background/Background: regression" begin
...
@testset "background/Background: interpolators" begin
