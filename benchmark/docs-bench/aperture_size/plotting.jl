...
plot(
    xticks = 0:50:200, yticks = logrange(1.0e-6, 1.0e-2, 5),
    ylims = (exp10(-6.5), exp10(-1.5)), yscale = :log10,
    markerstrokealpha = 0, link = :y, legend = :bottomright, layout = 2,
    size = (800, 300), dpi = 100, bottom_margin = 5StatsPlots.mm
)
