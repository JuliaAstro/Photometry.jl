...
@testsnippet interpolators begin
    import Photometry.Background: IDWInterpolator, ShepardIDWInterpolator
    import Random
    Random.seed!(8462852)
end

@testitem "background/interpolators: IDWInterpolator" setup=[interpolators] begin
...
@testitem "background/interpolators: ShepardIDWInterpolator" setup=[interpolators] begin
    # 1D
    x = rand(100)
    y = sin.(x)
