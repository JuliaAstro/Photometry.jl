...
@testsnippet rectangular begin
    using Photometry.Aperture: RectangularAperture, RectangularAnnulus,
                               bounds, center
end

@testitem "aperture/rectangular: Apertures" setup=[rectangular] begin
...
@testitem "aperture/rectangular: Rectangular Aperture" setup=[rectangular] begin
...
@testitem "aperture/rectangular: Rectangular Annulus" setup=[rectangular] begin
